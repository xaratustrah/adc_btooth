...
#define BUFFLEN     16 * 32 // 512 data points
  ...
  if (BTSerial.available()) {
    ...
    if (incomingByte == 97)
    {
      ...
      for (int i = 0; i < BUFFLEN; i = i + 16)
      {
        ...
        raw[i + 8] = adc.read(8);
        raw[i + 9] = adc.read(9);
        raw[i + 10] = adc.read(10);
        raw[i + 11] = adc.read(11);
        raw[i + 12] = adc.read(12);
        raw[i + 13] = adc.read(13);
        raw[i + 14] = adc.read(14);
        raw[i + 15] = adc.read(15);
